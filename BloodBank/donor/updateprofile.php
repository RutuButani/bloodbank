...
<div style="height:400px; width:700px; margin:auto; margin-top:100px; margin-bottom:100px; background-color:#f8f1e4; border:2px solid red; box-shadow:4px 1px 20px black;">
 <form method="post">
