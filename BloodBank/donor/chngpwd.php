...
<div style="height:300px; width:600px; margin:auto; margin-top:150px; margin-bottom:150px; background-color:#f8f1e4; border:2px solid red; box-shadow:4px 1px 20px black;">
<form method="post">
