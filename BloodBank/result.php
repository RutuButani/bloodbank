...
<div style=" height:auto">
  ...
  <table cellpadding="0" cellspacing="0" width="800px" height="400px" style="margin:auto; border:0px; margin-top : 100px; margin-bottom :100px;" class="tableborder">
        <tr><td  align="center"><img src="Images/results.png" height="80px" style="padding-top:20px; padding-left :20px;" /></td></tr>
        <tr><td >&nbsp;</td></tr> 
...
?>
 ...
 <a href="doner_pic<?php echo $data[8] ?>"data-lightbox="image-1"> <img src="doner_pic/<?php echo $data[8] ?>" height="100px" width="100px" style="margin:auto; padding-left:100px; padding-right:120px; float:left" /></a></td>
