...
<div class="main_cont">
     <div class="main">
        <div class="content">
          <img src="Images/camps.png" height="50px" style="margin:auto" />
            <br /><br />
...
$s="select * from camp,state,city where camp.state=state.state_id and camp.city=city.city_id";
    ...
    <tr><td style="font-size:24px; font-weight:bold; text-shadow:1px 1px 6px browm; padding-left:10px; padding-top:10px; padding-bottom:10px; color:#925959"><?php echo $data[1]; ?></td></tr>
      <tr><td align="center" style="width:100%"> 
   <a href="Admin/pic/<?php echo $data[5] ?>"data-lightbox="image-1"> <img src="Admin/pic/<?php echo $data[5] ?>" height="250px" width="400px" style="margin:auto; margin-top :20px;" /></a></td></tr>
    ...
    <tr><td>&nbsp;</td></tr>
          ...
          <tr><td class="title" style="vertical-align:middle">Organised By:<?php echo $data[2]; ?></td><td align="left" width="5%"></td></tr>
         <tr><td>&nbsp;</td><td>&nbsp;</td></tr>
         ...
         <tr><td>&nbsp;</td><td>&nbsp;</td></tr>
		<tr><td colspan="2"><p style="padding-left:20px;padding-bottom:20px; font-size:16px; font-weight:bold"><?php echo $data[2]; ?></p></td></tr>
		</table>
